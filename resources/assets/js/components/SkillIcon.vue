...
export default {
  ...
  data: () => ({
    icons: {
      ...
      javascript: { img: window.config.public_location + "images/javascript.png", background: ""},
      cPlusPlus: { img: window.config.public_location + "images/cPlusPlus.png", background: ""},
