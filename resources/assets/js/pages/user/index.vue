      ...
      <div class="col-md-12" id="user-cover-fluid">
        <div class="profile-tile-view">
          ...
          <div class="row">
            ...
            <div class="col-lg-10 col-md-9 col-7">
              <h3>{{user.name}}</h3>
              <label>{{workExperiences.length > 0 ? (workExperiences[0].is_current == 1 ? workExperiences[0].position :
                '' ) :''}}</label>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <card class="m-tb-10">
            <div>
              <h5>Description</h5>
              <label class="text-muted" v-if="!user.description && authorizeEdit"> How do you describe yourself?
              </label>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <card class="m-tb-10" title="Work Experience">
                ...
                <info-preview v-for="(experience, index) in workExperiences" icon="company" v-bind:key="index" :title="experience.company_name"
              ...
              <card class="m-tb-10" title="Educational Background">
                ...
                <info-preview v-for="(education, index) in educationalBackgrounds" v-bind:key="index" icon="school"
                  :title="education.school_name" :subtitle="education.course">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group row">
                  ...
                  <div class="col-md-7">
                    <textarea v-model="userDescriptionForm.description" :class="{ 'is-invalid': userDescriptionForm.errors.has('description') }"
  ...
  export default {
    ...
    methods: {
      ...
      async updateUserPhoto(photo_data) {
        ...
        const {
          data
        } = await form.patch('/api/userInfo/update/photo');
      ...
      async validateSkillsForm() {
        const {
          data
        } = await this.skillsForm.post('/api/userInfo/update/skills');
      ...
      async updateDescription() {
        const {
          data
        } = await this.userDescriptionForm.post('/api/userInfo/update/user_description');
        ...
        swal({
          ...
          if (result.value) {
            axios({
              ...
              params: {
                education_background_id: data.id
              }
            }).then(data => {
              if (data.data == 'deleted') {
